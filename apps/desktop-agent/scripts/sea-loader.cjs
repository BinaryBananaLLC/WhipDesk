...
// (ffmpeg-static, sharp, @nut-tree-fork/libnut, werift) resolve from the sibling
// `resources/node_modules` exactly as they would in a normal `npm install`. No per-package
