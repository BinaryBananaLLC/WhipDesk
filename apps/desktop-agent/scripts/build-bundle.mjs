...
// EXTERNAL lives in its own esbuild-free module (see bundle-externals.mjs) so check-install-clean.mjs
// can read it without loading esbuild. Re-exported here for callers that already import from this file.
